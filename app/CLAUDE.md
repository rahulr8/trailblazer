...
|----|------|---|-------|------|
| #646 | 7:32 PM | 🔄 | Made onboarding screen navigation callback-based | ~274 |
| #641 | 7:31 PM | 🔴 | Fixed login screen layout with absoluteFillObject | ~261 |
| #639 | 7:30 PM | 🔴 | Removed fullScreenModal presentation from login screen | ~250 |
| #634 | 7:28 PM | ✅ | Disabled unstable_settings anchor configuration in root layout | ~325 |
| #631 | 7:27 PM | 🔄 | Refactored login screen layout for responsive button sizing | ~436 |
| #628 | 7:25 PM | 🔴 | Fixed onboarding screen layout displaying only half screen | ~267 |
| #625 | 7:20 PM | 🔴 | Fixed login screen layout width constraint | ~238 |
